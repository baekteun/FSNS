...
public enum FashionAsset {
  ...
  public static let fashionHanger = FashionImages(name: "FASHION_Hanger")
...
public final class FashionColors {
...
public extension FashionColors.Color {
  @available(iOS 11.0, tvOS 11.0, watchOS 4.0, macOS 10.13, *)
  convenience init?(asset: FashionColors) {
    let bundle = FashionResources.bundle
    #if os(iOS) || os(tvOS)
...
public extension FashionImages.Image {
  @available(macOS, deprecated,
    message: "This initializer is unsafe on macOS, please use the FashionImages.image property")
  convenience init?(asset: FashionImages) {
    #if os(iOS) || os(tvOS)
    let bundle = FashionResources.bundle
    self.init(named: asset.name, in: bundle, compatibleWith: nil)
    #elseif os(macOS)
